    ...
    return (
        <section className="py-20 bg-gradient-to-b from-black via-gray-900 to-black relative overflow-hidden">
            ...
            <div className="absolute inset-0">
                <div className="absolute top-20 left-10 w-96 h-96 bg-orange-600/5 rounded-full blur-3xl animate-pulse" />
                <div className="absolute bottom-20 right-10 w-80 h-80 bg-orange-500/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '3s' }} />
            </div>
            ...
            <div className="relative max-w-7xl mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="space-y-8">
                        <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/10 border border-orange-500/30 rounded-full text-sm font-medium text-orange-400">
                            Powered by Chatwoot
                        </div>
                        ...
                        <div className="space-y-4">
                            {[
                                ...
                                <div key={index} className="flex gap-4 group">
                                    <div className="flex-shrink-0 w-6 h-6 rounded-full bg-orange-500/20 flex items-center justify-center mt-1 group-hover:bg-orange-500/30 transition-colors">
                                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M20 6L9 17L4 12" stroke="#f97316" strokeWidth="3" strokeLinecap="round" strokeLinejoin="round" />
                                        </svg>
                                    </div>
                                    <div>
                                        <h3 className="font-semibold text-white mb-1 group-hover:text-orange-100 transition-colors">{item.title}</h3>
                        ...
                        <div className="flex items-center gap-4 pt-4">
                            <a href="#cta" className="bg-gradient-to-r from-orange-600 to-orange-700 hover:from-orange-700 hover:to-orange-800 text-white font-bold px-6 py-3 rounded-xl transition-all duration-300 hover:scale-105 shadow-lg shadow-orange-500/25">
                                Start Free Trial
                            </a>
                            <a href="#features" className="text-orange-400 font-medium hover:text-orange-300 flex items-center gap-2 transition-colors">
                                View All Features
                    ...
                    <div className="relative">
                        ...
                        <div className="bg-black/40 backdrop-blur-md rounded-2xl shadow-2xl overflow-hidden border border-orange-500/20">
                            {/* Header */}
                            <div className="bg-gradient-to-r from-orange-600 to-orange-700 px-6 py-4 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-orange-100 text-sm">Your Shopify Store</div>
                                    </div>
                                </div>
                            ...
                            <div className="p-6 space-y-4 h-80 overflow-hidden">
                                ...
                                <div className="flex gap-3 justify-end">
                                    <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-2xl rounded-tr-sm px-4 py-3 max-w-xs">
                                        ...
                                        <span className="text-orange-100 text-xs mt-1 block">2:35 PM</span>
                                    </div>
                                    <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-400 to-orange-600 flex-shrink-0"></div>
                                </div>
                                ...
                                {/* Agent Typing */}
                                <div className="flex gap-3 justify-end">
                                    <div className="bg-gradient-to-r from-orange-500/50 to-orange-600/50 rounded-2xl rounded-tr-sm px-4 py-3">
                            ...
                            <div className="border-t border-orange-500/20 p-4">
                                <div className="flex gap-3 items-center">
                                    <input 
                                        ...
                                        disabled
                                    />
                                    <button className="bg-gradient-to-r from-orange-500 to-orange-600 p-2 rounded-lg">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div className="absolute -bottom-6 -right-6 bg-gradient-to-r from-orange-500 to-orange-600 rounded-full p-4 shadow-xl shadow-orange-500/25">
