                    ...
                    <div className="text-center">
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            {[
                                ...
                                <div key={index} className="bg-black/40 backdrop-blur-md rounded-2xl border border-orange-500/20 p-6 hover:border-orange-500/40 transition-all duration-300">
